...
//        if (ma != null && ma.berechneAlter() >= 15 && !mitarbeiter.contains(ma)) {
//            return mitarbeiter.add(ma);
//        } else {
//            System.out.println("Fehler: mitarbeiter ungültig (null oder zu jung oder schon vorhanden)");
//            return false;
//        }
    }
...
//            if(iterator.next() instanceof Freelancer) {
//                count++;
//            }
//        }
//        return count;
...
//        }
    ...
    public void sortierenNachAlter() {
        mitarbeiter.sort(new AlterComparator());

//        Comparator<Mitarbeiter> nachAlterComparator = new AlterComparator();
//        mitarbeiter.sort(nachAlterComparator);
    }

    public void sortierenNachDienstalter() {
        // mit DienstalterComparator-Klasse implements Comparator
        mitarbeiter.sort(new DienstalterComparator());
    }

    public void sortierenNachDienstalterAbsteigend() {
        // mit DienstalterComparator-Klasse implements Comparator
        mitarbeiter.sort(new DienstalterComparator().reversed());
    }
    ...
    public void readPersonalFromCsv() {
        String filepath = "src/main/resources/mitarbeiterData.csv";
