...
//        testGetMitarbeiter();
    ...
    private static void testCsv() {
        Mitarbeiter angestellter = null;
        Mitarbeiter arzt = null;
        Mitarbeiter freelancer = null;
        Personalbuero personalbuero = null;
        try {
            angestellter = new Angestellter("Anna", Year.of(2001), Year.now());
            arzt = new Arzt("Schmid", Year.of(2005),Year.now(), 40, 20000.0);
            freelancer = new Freelancer("Jakob", Year.of(1990), Year.of(2020), 75.0, 20);
//            System.out.println(angestellter.toCsvString());
//            System.out.println(arzt.toCsvString());
//            System.out.println(freelancer.toCsvString());

            personalbuero = new Personalbuero();
//            personalbuero.aufnehmen(arzt);
//            personalbuero.aufnehmen(angestellter);
//            personalbuero.aufnehmen(freelancer);
//            personalbuero.writePersonalToCsv();

            personalbuero.readPersonalFromCsv();
            System.out.println(personalbuero.toString());

        } catch (PersonalException e) {
            System.out.println("Fehler beim erstellen des Angestellters!");;
        }
    }
